...
<html lang="en">
  <head>
    ...
    <!-- Favicons -->
    <link href="assets/img/wet_klopo.png" rel="icon" />
    <link href="assets/img/wet_klopo.png" rel="apple-touch-icon" />
  ...
  <body>
    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
      <div class="container d-flex align-items-center justify-content-between">
        ...
        <!-- <h1>coco store<span>.</span></h1>
        </a> -->

        <div class="logo">
          <!-- <img class="p-2" src="assets/img/logobruge.jpg" style="width: 25%; border-radius: 50px;"> -->
          <h1 class="text-light">
            <img
              id="logobruge"
              class="d-inline-block align-text-top"
              src="assets/img/wet_klopo.png"
              alt="Logo"
              width="50"
              height="50"
            />
            <a href="index.html"><b>coco store</b></a>
          </h1>
        ...
        <!-- <a class="btn-book-a-table" href="login/app/index.php">login</a> -->
        <!-- <a class="btn-book-a-table" href="admincoco/index.php">login</a> -->
        <a class="btn-book-a-table" href="login/index.php">login</a>
    ...
    <section id="hero" class="hero d-flex align-items-center section-bg">
      <div class="container">
        <div class="row justify-content-between gy-5">
          ...
          >
            <h2 data-aos="fade-up">"Kisah Kelezatan Dalam <br />Setiap Potongan Kelapa."</h2>
        ...
        <div class="container" data-aos="fade-up">
          ...
          <div class="row gy-4">
            <div
              ...
              style="background-image: url(assets/img/bpkkk.jpg)"
              data-aos="fade-up"
              data-aos-delay="150"
            >
            ...
            >
              <div class="content ps-0 ps-lg-5">
                <p class="fst-italic">
                Selamat datang di cocostore!

Kami adalah tim yang berkomitmen untuk membawa kelezatan dan manfaat kelapa langsung ke rumah Anda. Dengan keyakinan bahwa alam memiliki banyak harta yang bisa memberikan kesehatan dan kelezatan, kami telah mengabdikan diri kami untuk menyediakan produk kelapa berkualitas tertinggi kepada Anda.                </p>
                <ul>
                  <li>
                    <i class="bi bi-check2-all"></i> kejujuran.
                  </li>
                  <li>
                    <i class="bi bi-check2-all"></i> keberlanjutan.
                  </li>
                  <li>
                    <i class="bi bi-check2-all"></i> kualitas.
                  </li>
                </ul>
                <p>
                adalah nilai inti yang membimbing setiap langkah kami. Kami tidak hanya menjual produk kelapa, tetapi juga berbagi cerita tentang asal-usul setiap produk dan bagaimana setiap langkah dalam proses produksi kami dikelola dengan hati-hati. Tim kami terdiri dari para ahli kelapa yang penuh semangat dan berdedikasi. Kami senang dapat berbagi pengetahuan kami tentang kelapa dan bagaimana produk-produk kami dapat menjadi bagian dari gaya hidup sehat dan alami Anda. Terima kasih telah berkunjung ke website kami. Jangan ragu untuk menjelajahi lebih lanjut tentang produk-produk kami dan jangan sungkan untuk menghubungi kami jika Anda memiliki pertanyaan atau ingin berbagi pengalaman Anda dengan produk kami. Kami sangat berharap dapat membawa kelezatan tropis dan manfaat alami langsung ke rumah Anda!
...
Tim cocostore
      ...
      <section id="menu" class="menu">
        <div class="container" data-aos="fade-up">
          <div class="section-header">
            <h2>Our Menu</h2>
            <p>Check Our <span>coco store</span></p>
          </div>
          ...
          <div class="tab-content" data-aos="fade-up" data-aos-delay="300">
            <div class="tab-pane fade active show" id="menu-starters">
              ...
              <div class="row gy-5">
                <div class="col-lg-4 menu-item">
                  <a href="assets/img/klopoo.jpg" class="glightbox"
                    ><img
                      src="assets/img/klopoo.jpg"
                      class="menu-img img-fluid" style="width: 100%; height: 250px;"
                      alt=""
                  /></a>
                  <h4>kelapa</h4>
                  <p class="ingredients">
                ...
                <div class="col-lg-4 menu-item">
                  <a href="assets/img/kelapa_parut.png" class="glightbox"
                    ><img
                      src="assets/img/kelapa_parut.png"
                      class="menu-img img-fluid" style="width: 100%; height: 250px;"
                      alt=""
                  /></a>
                  <h4>kelapa parut</h4>
                ...
                <div class="col-lg-4 menu-item">
                  <a href="assets/img/sabut_klopo.jpg" class="glightbox"
                    ><img
                      src="assets/img/sabut_klopo.jpg"
                      class="menu-img img-fluid" style="width: 100%; height: 250px;"
                      alt=""
                  /></a>
                  <h4>sabut kelapa</h4>
                ...
                <div class="col-lg-4 menu-item">
                  <a href="assets/img/batok.png" class="glightbox"
                    ><img
                      src="assets/img/batok.png"
                      class="menu-img img-fluid" style="width: 100%; height: 250px;"
                      alt=""
                  /></a>
                  <h4>batok kelapa</h4>
                  ...
                  <p class="price">110k</p>
                </div>
                <!-- Menu Item -->

                <div class="col-lg-4 menu-item">
                  <a href="assets/img/air_kelapa.png" class="glightbox"
                    ><img
                      src="assets/img/air_kelapa.png"
                      class="menu-img img-fluid" style="width: 100%; height: 250px;"
                      alt=""
                  /></a>
                  <h4>air kelapa</h4>
                ...
                <div class="col-lg-4 menu-item">
                  <a href="assets/img/bibit_klapa.png" class="glightbox"
                    ><img
                      src="assets/img/bibit_klapa.png"
                      class="menu-img img-fluid" style="width: 100%; height: 250px;"
                      alt=""
                  /></a>
                  <h4>bibit kelapa</h4>
            ...
            <div class="tab-pane fade" id="menu-breakfast">
              ...
              <div class="row gy-5">
                <div class="col-lg-4 menu-item">
                  <a href="assets/img/santen2.png" class="glightbox"
                    ><img
                      src="assets/img/santen2.png"
                      class="menu-img img-fluid" style="width: 100%; height: 250px;"
                      alt=""
                  /></a>
                  <h4>santan kelapa</h4>
            ...
            >
              <div class="chef-member">
                <div class="member-img">
                  ...
                  />
                  <div class="social">
                    <a href="https://twitter.com/Dellaxsariii?t=oupl61FeaEsNHs75cn8ghA&s=08"><i class="bi bi-twitter"></i></a>
                    <a href="https://www.facebook.com/profile.php?id=100033329119341"><i class="bi bi-facebook"></i></a>
                    <a href="https://instagram.com/psptsrdll_?igshid=YmMyMTA2M2Y="><i class="bi bi-instagram"></i></a>
                    <a href="http://tiktok.com/@della_pspt03"><i class="bi bi-tiktok"></i></a>
                  </div>
                </div>
